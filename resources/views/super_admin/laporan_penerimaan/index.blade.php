<x-super_admin.layout>
            <div class="row">
              <div class="col-md-12">
                <a class="btn btn-light border-primary" href="{{ route('super_admin.laporan_penerimaan.pdf', request()->query()) }}"><i class="mdi mdi-download align-middle"></i> Download Laporan (pdf)</a>
                <div class="card rounded mt-3">
                  <div class="card-body">
                    <h4 class="card-title">Laporan Penerimaan Pembayaran Siswa</h4>
                    <div class="d-flex gap-3">
                      {{-- Filter Tahun Ajaran --}}
                      <form method="GET" action="{{ route('super_admin.laporan_penerimaan') }}" class="d-flex gap-3">
