<x-super_admin.layout title="Profil Siswa">
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card rounded">
                  <div class="card-body">
                    <h4 class="card-title">Profil Siswa</h4>
                    <form class="form-sample" action="{{ route('super_admin.profil_siswa.update', $student) }}" method="POST">
                      @csrf
                      @method('PUT')
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-12 d-flex justify-content-end">
                            ...
                            <a href="{{ route('super_admin.data_siswa') }}" class="btn btn-light btn-sm"><i class="mdi mdi-close align-middle"></i> Batal</a>
                          </div>
                        </div>
                      </div>
                    </form>
