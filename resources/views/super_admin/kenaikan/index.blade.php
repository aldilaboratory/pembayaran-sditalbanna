<x-super_admin.layout title="Kenaikan Kelas Siswa">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card rounded">
        <div class="card-body">
          ...
          <form id="promoteForm" action="{{ route('super_admin.kenaikan.promote') }}" method="POST">
            @csrf
  ...
  <script>
    ...
    async function loadStudents(classId){
      ...
      try{
        const url = new URL("{{ route('super_admin.kenaikan.students') }}", window.location.origin);
