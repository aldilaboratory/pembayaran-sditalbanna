<x-super_admin.layout>
            <div class="row">
              <div class="col-md-12">
                <a class="btn btn-light border-primary" href="{{ route('super_admin.laporan_tunggakan_siswa.pdf', request()->query()) }}"><i class="mdi mdi-download align-middle"></i> Download Laporan (pdf)</a>
                <div class="card rounded mt-3">
                  <div class="card-body">
                    <h4 class="card-title">Laporan Tunggakan Siswa</h4>
                    <form method="GET" action="{{ route('super_admin.laporan_tunggakan_siswa') }}" class="d-flex gap-3">
