<x-super_admin.layout title="Admin - Data Tagihan Siswa">
    ...
    .search-spinner.show {
        display: block;
            ...
            <div class="row">
              <div class="col-md-12">
                <a href="{{ route('super_admin.data_tagihan_siswa.create') }}" class="btn btn-primary mb-3">+ Input Tagihan Siswa</a>
              </div>
            </div>
            <div class="row">
                ...
                <div class="card rounded">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <form id="searchForm" action="{{ route('super_admin.data_tagihan_siswa.search') }}" method="POST">
                        @csrf
                              ...
                              <tr>
                                ...
                                <td class="text-center">
                                  @if($fee->status == 'lunas')
                                    ...
                                    @if ($successTx)
                                      <a href="{{ route('super_admin.transactions.show', $successTx) }}"
                                  ...
                                  @else
                                    <a href="javascript:void(0)"
                                      ...
                                      data-url="{{ route('super_admin.school-fees.mark-paid-offline', $fee) }}"
                                      data-fee-id="{{ $fee->id }}"
                                    ...
                                    <a href="javascript:void(0)"
                                      ...
                                      data-url="{{ route('super_admin.data_tagihan_siswa.destroy', $fee) }}"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function fetchAutocomplete(query) {
            try {
                const response = await fetch(`{{ route('super_admin.data_tagihan_siswa.autocomplete') }}?q=${encodeURIComponent(query)}`, {
                    headers: {
        ...
        function selectStudent(index) {
            ...
            if (student) {
                ...
                searchForm.action = "{{ route('super_admin.data_tagihan_siswa.search.byId') }}";
        ...
        function clearSelection() {
            ...
            searchForm.action = "{{ route('super_admin.data_tagihan_siswa.search') }}";
        }
        ...
        searchForm.addEventListener('submit', function(e) {
            ...
            if (studentIdInput.value) {
                this.action = "{{ route('super_admin.data_tagihan_siswa.search.byId') }}";
            } else {
                // Jika tidak ada, gunakan search biasa
                this.action = "{{ route('super_admin.data_tagihan_siswa.search') }}";
            }
        });
