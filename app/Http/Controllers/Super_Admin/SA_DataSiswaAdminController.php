...
class SA_DataSiswaAdminController extends Controller
{
    ...
    public function create() {
        ...
        return view('super_admin.data_siswa.create', compact('studentClasses', 'schoolYears'));
    }
    ...
    public function edit($id) {
        ...
        return view('super_admin.data_siswa.edit', compact('students', 'studentClasses', 'schoolYears'));
    }
