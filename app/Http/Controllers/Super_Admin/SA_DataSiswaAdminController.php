...
class SA_DataSiswaAdminController extends Controller
{
    public function index() {
        ...
        return view('super_admin.data_siswa.index', compact('students'));
    }
    ...
    public function create() {
        ...
        return view('super_admin.data_siswa.create', compact('studentClasses', 'schoolYears', 'academicYears'));
    }
    ...
    public function edit($id) {
        ...
        return view('super_admin.data_siswa.edit', compact('students', 'studentClasses', 'schoolYears', 'academicYears'));
    }
