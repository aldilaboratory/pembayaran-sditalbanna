...
class SA_DataTagihanSiswaAdminController extends Controller
{
    public function index() {
        return view('super_admin.data_tagihan_siswa.index');
    }
    ...
    public function searchById(Request $request)
    {
        ...
        return view('super_admin.data_tagihan_siswa.index', compact('student'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('super_admin.data_tagihan_siswa.create', compact(
    ...
    public function store(StoreSchoolFeesRequest $request)
    {
        try {
            ...
            return redirect()
                ->route('super_admin.data_tagihan_siswa.create', ['class_id' => $request->class_id])
    ...
    public function markPaidOffline(Request $request, SchoolFee $fee)
    {
        ...
        try {
            $result = DB::transaction(function () use ($request, $fee) {
                ...
                return [
                    'download_url' => route('super_admin.transactions.pdf', $tx),
