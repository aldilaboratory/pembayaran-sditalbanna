...
class SA_KenaikanKelasController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('super_admin.kenaikan.index', compact('classes','academicYears','selectedFrom','selectedTo','selectedAy'));
    }
