...
class SA_DataKelasController extends Controller
{
    public function index() {
        $classes = StudentClass::all()->sortBy('class');

        return view('super_admin.data_kelas.index', compact('classes'));
    }

    public function create() {
        return view('super_admin.data_kelas.create');
    }
    ...
    public function store(StoreStudentClassesRequest $request) {
        ...
        return redirect()->route('super_admin.data_kelas')
    ...
    public function edit($id) {
        ...
        return view('super_admin.data_kelas.edit', compact('classes'));
    }
