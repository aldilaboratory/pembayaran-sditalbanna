...
class SA_LaporanPenerimaanController extends Controller
{
    ...
    return view('super_admin.laporan_penerimaan.index', compact(
    ...
    public function pdf(Request $request) {
        ...
        $pdf = Pdf::loadView('super_admin.laporan_penerimaan.pdf', compact(
