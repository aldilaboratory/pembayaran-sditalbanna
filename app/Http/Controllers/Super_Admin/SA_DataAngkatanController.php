...
class SA_DataAngkatanController extends Controller
{
    public function index() {
        $schoolYears = SchoolYear::all()->sortBy('school_year');

        return view('super_admin.data_angkatan.index', compact('schoolYears'));
    }

    public function create() {
        return view('super_admin.data_angkatan.create');
    }

    public function store(StoreSchoolYearsRequest $request) {
        SchoolYear::create($request->validated());

        return redirect()->route('super_admin.data_angkatan')
    ...
    public function edit($id) {
        ...
        return view('super_admin.data_angkatan.edit', compact('schoolYears'));
    }
    ...
    public function destroy($id) {
        ...
        if ($count > 0) {
            return redirect()
                ->route('super_admin.data_angkatan')
