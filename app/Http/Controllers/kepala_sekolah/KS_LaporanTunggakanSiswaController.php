...
class KS_LaporanTunggakanSiswaController extends Controller
{
    public function index(Request $request) {
        ...
        return view('kepala_sekolah.laporan_tunggakan_siswa.index', compact(
     ...
     public function pdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('kepala_sekolah.laporan_tunggakan_siswa.pdf', compact(
